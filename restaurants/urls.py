...
urlpatterns = [
    ...
    path('menu/<int:item_pk>/delete/', views.menu_delete, name='menu_delete'),
    path('review/<int:review_pk>/reply/', views.reply_add, name='reply_add'),
    path('review/<int:review_pk>/like/', views.like_review, name='like_review'),
